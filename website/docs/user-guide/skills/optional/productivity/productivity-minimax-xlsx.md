---
title: "Minimax Xlsx — Open, create, read, analyze, edit, or validate Excel/spreadsheet files ("
sidebar_label: "Minimax Xlsx"
...
| | |
|---|---|
| Source | Optional — install with `hermes skills install official/productivity/minimax-xlsx` |
| Path | `optional-skills/productivity/minimax-xlsx` |
| Version | `1.0` |
| Author | MiniMaxAI |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `excel`, `xlsx`, `spreadsheet`, `ooxml`, `productivity`, `minimax` |
| Related skills | [`excel-author`](/docs/user-guide/skills/optional/finance/finance-excel-author), [`google-workspace`](/docs/user-guide/skills/bundled/productivity/productivity-google-workspace), [`ocr-and-documents`](/docs/user-guide/skills/bundled/productivity/productivity-ocr-and-documents) |
