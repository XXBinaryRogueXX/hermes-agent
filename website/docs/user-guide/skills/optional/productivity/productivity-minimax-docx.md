---
title: "Minimax Docx — Professional DOCX document creation, editing, and formatting using OpenXML SDK ("
sidebar_label: "Minimax Docx"
description: "Professional DOCX document creation, editing, and formatting using OpenXML SDK ("
---
...
| | |
|---|---|
| Source | Optional — install with `hermes skills install official/productivity/minimax-docx` |
| Path | `optional-skills/productivity/minimax-docx` |
| Version | `1.0.0` |
| Author | MiniMaxAI |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `docx`, `word`, `openxml`, `documents`, `productivity`, `minimax` |
| Related skills | [`google-workspace`](/docs/user-guide/skills/bundled/productivity/productivity-google-workspace), [`ocr-and-documents`](/docs/user-guide/skills/bundled/productivity/productivity-ocr-and-documents), [`nano-pdf`](/docs/user-guide/skills/bundled/productivity/productivity-nano-pdf) |
...
**Safety note:** the bundled upstream setup scripts can install system packages, download the .NET installer, and modify shell profile files. Inspect them before running, prefer `--minimal` for agent sessions, and get explicit user approval before any `sudo`, package-manager, remote-script, or profile-edit step.
