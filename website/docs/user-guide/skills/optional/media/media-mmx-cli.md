---
title: "Mmx Cli"
sidebar_label: "Mmx Cli"
description: "Use when the user wants MiniMax's official mmx CLI for text chat, image/video generation, speech, music, vision, web search, quota checks, file upload, or Mi..."
---
...
Use when the user wants MiniMax's official mmx CLI for text chat, image/video generation, speech, music, vision, web search, quota checks, file upload, or MiniMax API resource management from a terminal.

## Skill metadata

| | |
|---|---|
| Source | Optional — install with `hermes skills install official/media/mmx-cli` |
| Path | `optional-skills/media/mmx-cli` |
| Version | `1.0.0` |
| Author | MiniMaxAI (adapted by Nous Research) |
| License | MIT |
| Platforms | linux, macos, windows |
| Tags | `minimax`, `mmx`, `cli`, `image`, `video`, `speech`, `music`, `search`, `vision` |
| Related skills | [`comfyui`](/docs/user-guide/skills/bundled/creative/creative-comfyui), [`heartmula`](/docs/user-guide/skills/bundled/media/media-heartmula), [`songsee`](/docs/user-guide/skills/bundled/media/media-songsee), [`youtube-content`](/docs/user-guide/skills/bundled/media/media-youtube-content) |
